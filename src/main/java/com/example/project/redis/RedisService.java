...
public class RedisService<HK, V> {
    ...
    public void setValue(String key, V value) {
        log.info("设置：key="+key+"    value="+value);
     ...
     * @return
     */
    public Long getStringIncrementValue(String key) {
     ...
     * @return
     */
    public List<String> queryKeyList(String pattern) {

        return valueOperations.getOperations().keys(pattern).stream().collect(Collectors.toList());
    }
